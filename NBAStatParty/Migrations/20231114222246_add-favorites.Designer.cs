...
namespace NBAStatParty.Migrations
{
    ...
    [Migration("20231114222246_add-favorites")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBAStatParty.Models.DbModels.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("NBAStatParty.Models.DbModels.Team", b =>
                {
                    ...
                    b.HasIndex("ConferenceId")
                        .HasDatabaseName("ix_teams_conference_id");
            ...
            modelBuilder.Entity("NBAStatParty.Models.DbModels.Team", b =>
                {
                    b.HasOne("NBAStatParty.Models.DbModels.Conference", null)
                        .WithMany("Teams")
                        .HasForeignKey("ConferenceId")
                        .HasConstraintName("fk_teams_conferences_conference_id");
